...
export default function Hero(){
  ...
  useState(bigShoe1)
  return (
    <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 mx-20 max-container ">
<div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
    ...
    iconURL={arrowRight}/>
    <div className="flex justfy-start items-start flex-wrap w-full mt-20 gap-16">
